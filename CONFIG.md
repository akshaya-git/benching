...
| `repo` | string | no | The Hugging Face repo behind a normalized served id (used for cache mapping in discovery). Set this when `model` is a normalized id that differs from the repo name. |
